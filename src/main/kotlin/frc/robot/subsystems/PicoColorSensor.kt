...
public class PicoColorSensor implements AutoCloseable {
    ...
    private findNextComma(byte[] data, int readLen, int lastComma): int {
      while (true) {
    ...
    private val debugPrints = AtomicBoolean;
    private var hasColor0: boolean;
    private var hasColor1: boolean;
    public var prox0: int;
    public var prox1: int;
    public val color0: RawColor;
    public val color1: RawColor;
    private val lastReadTime: double;
    private val threadLock: ReentrantLock;
    private val readThread: Thread ;
    private val threadRunning AtomicBoolean = AtomicBoolean(true);
  
    private fun threadMain(): void {
