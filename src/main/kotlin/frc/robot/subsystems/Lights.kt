...
class Lights(tab: ShuffleboardTab) : SubsystemBase() {
    ...
    public fun setRainbow() {
        //for(i in 0..5) {
            //val cach: RGB = cached[(index + i) % 360];
            //println("${cach.r}, ${cach.g}, ${cach.b}");
            //candle.setLEDs(cach.r, cach.g, cach.b, 255, i, 1)
            //candle.setLEDs(index, 0, 0, 255, i * 20, 20)
        //}
        // val cach: RGB = cached[index];
        // candle.setLEDs(cach.r, cach.g, cach.b, 255, 0, 38)
        // candle.setLEDs(cach.g, cach.b, cach.r, 255, 38, 1)
        candle.animate(RainbowAnimation(1.0, 0.63, 68))
    }
