...
// class EnemyShoot(m_drivetrain: Drivetrain, m_shooter: Shooter, m_vision: Vision, m_indexer: Indexer, m_feeder: Feeder, m_intake: Intake, m_deploy: DeploySubsystem, m_lights: Lights, m_driver: XboxController) : SequentialCommandGroup() {
...
//             ParallelRaceGroup(
//                 RunIntake(intake, deploy, feeder, 3.0),
