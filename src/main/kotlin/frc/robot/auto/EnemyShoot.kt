...
class EnemyShoot(m_drivetrain: Drivetrain, m_shooter: Shooter, m_vision: Vision, m_indexer: Indexer, m_feeder: Feeder, m_intake: Intake, m_lights: Lights) : SequentialCommandGroup() {
        ...
        addCommands(
            ...
            ParallelRaceGroup(
                ...
                SequentialCommandGroup(
                    ...
                    ShootAndFeed(shooter, feeder, indexer, lights, 10000.0, 10000.0, 4.0)
                )
            )
        )
    }
