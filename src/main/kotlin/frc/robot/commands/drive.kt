...
class Drive(_drivetrain: ExampleDrivetrain, _controller: XboxController) : CommandBase() {
  ...
  override fun execute() {
      ...
      drivetrain.leaderLeft.set(ControlMode.PercentOutput, .5*(controller.getLeftY() - controller.getLeftX())) // the % output of the motor, between -1 and 1
      drivetrain.leaderRight.set(ControlMode.PercentOutput, -0.5*(controller.getLeftY() + controller.getLeftX())) // the % output of the motor, between -1 and 1
  }
