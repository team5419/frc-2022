...
class ToggleCurrent(_drivetrain: Drivetrain) : CommandBase() {
  ...
  override fun initialize() {
    drivetrain.leftLeader.configSupplyCurrentLimit(SupplyCurrentLimitConfiguration(true, 80.0, 0.0, 0.0), 100);
    drivetrain.leftFollower.configSupplyCurrentLimit(SupplyCurrentLimitConfiguration(true, 80.0, 0.0, 0.0), 100);
    drivetrain.rightLeader.configSupplyCurrentLimit(SupplyCurrentLimitConfiguration(true, 80.0, 0.0, 0.0), 100);
    drivetrain.rightFollower.configSupplyCurrentLimit(SupplyCurrentLimitConfiguration(true, 80.0, 0.0, 0.0), 100);
  }
